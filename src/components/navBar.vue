<template>
  ...
  >
    ...
    >
      ...
      <div
        ref="menu"
        class="w-full sm:flex sm:items-center sm:w-auto h-screen sm:h-full my-[50%] mx-[20%] sm:m-auto sm:block sm:mt-0 sm:bg-white sm:bg-transparent text-black p-4 sm:p-0 z-20"
        :class="menu ? '' : 'hidden'"
      >
