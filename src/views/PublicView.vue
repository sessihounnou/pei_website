<template>
    <section>
        <div class="bg-image-s1 absolute sm:h-[600px] h-[400px] bg-cover">
            <div class="bg-[#1371B9] sm:h-[600px] h-[400px] bg-opacity-30">
                ...
                <div class="sm:ml-[200px] ml-8 mt-[15px] sm:mt-[70px]">
                    <div
                        class="bg-[#0988E9] sm:h-[62px] h-[40px] sm:w-[17%] w-[110px] sm:ml-[0px] ml-[20px] sm:py-[10px] py-[7px] rounded-[10px]">
        ...
        <img src="../assets/Vector2.png" alt=""
          ...
          <img src="../assets/image5.png" alt="" class="w-[400px] sm:w-[500px] border-4 border-[#008C36] rounded border-opacity-900 ">
          <div class=" "> 
              <p class=" text-[30px] sm:text-[32px] font-semibold sm:font-semibold  leading-loose">Secteur Public </p>
              <div class="text-[15px] sm:text-[18px]"> 
                 
                  <p>
                      <li class="ml-5 sm:ml-10" > Gouvernement</li> 
                      <li class="ml-5 sm:ml-10">Ministères</li>  
                      <li class="ml-5 sm:ml-10">Institutions</li> 
                      <li class="ml-5 sm:ml-10">Communes</li>
                  </p>                
