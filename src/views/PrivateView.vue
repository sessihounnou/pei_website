<template>
  <section>
    ...
    <div class="flex flex-col gap-2 sm:flex sm:flex-row sm:gap-20 m-[30px] sm:m-[120px]">
      ...
      <div class=" ">
        <p class=" text-[30px] sm:text-[32px] font-semibold sm:font-semibold  leading-loose">Secteur Privé </p>
        <div class="text-[15px] sm:text-[18px]">

          <p>
            <li class="ml-5 sm:ml-10"> Micro-entreprises</li>
            <li class="ml-5 sm:ml-10">PME/PMI</li>
            <li class="ml-5 sm:ml-10">Multinationales</li>
