      ...
      <div class=" "> 
          ...
          <div class="text-[15px] sm:text-[18px]"> 
              <p class=" sm:mr-[30px]"> 
                  ...
                  modernes,nous proposons à nos clients:
              </p>
              <p>
                  <li class="ml-5 sm:ml-10">des séminaires publics ;</li> 
                  <li class="ml-5 sm:ml-10">des séminaires inter-entreprises /institutions ;</li>  
                  <li class="ml-5 sm:ml-10">des séminaires intra-entreprises /institutions;</li> 
                  <li class="ml-5 sm:ml-10">des formations-coaching personnalisées;</li>
                  <li class="ml-5 sm:ml-10">des formations à distance ;</li>
                  <li class="ml-5 sm:ml-10">des formations en ligne.</li>
